...
<div id="{{$id}}" {{$attributes->merge(['class' => 'modal-container h-full w-full top-0 z-10 
    absolute bg-gray-100 bg-opacity-60 hidden'])}}>
    ...
    <div class="h-full w-4/5 flex mx-auto items-center">
        <div class="dialog-box h-44 w-96 p-12 bg-slate-600 rounded-xl text-slate-200 
            ...
            <div class="flex gap-x-2">
                ...
                <x-link-button :link="$redirection" text="Continue"/>
            </div>
        </div>
    </div>
</div>